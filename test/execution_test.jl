...
function generate_command_list()
    return CommandList([
        QXRun.ParametricCommand{LoadCommand}("t878 \$o1")
        QXRun.ParametricCommand{LoadCommand}("t879 \$o2")
        QXRun.ParametricCommand{LoadCommand}("t880 \$o3")
        ...
        QXRun.ParametricCommand{ViewCommand}("t880_v3 t880 1 \$v3")
        QXRun.ParametricCommand{ViewCommand}("t874_v2_v3_v4 t874_v2_v3 2 \$v4")
        QXRun.ParametricCommand{ViewCommand}("t879_v4 t879 1 \$v4")
        NconCommand(:t881, :t873_v1_v2, [-1,1,-2,-3], :t878, [1])
