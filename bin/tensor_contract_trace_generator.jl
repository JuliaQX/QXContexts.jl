...
Generates random tensors of increasing rank to performan contractions with.
    ...
    for idx_left in 0:tensor_rank
        ...
        for idx_right in 0:tensor_rank
            ...
            for shift_idx in 0:idx_left
                ...
                @info "Contracting L=$(t_label_left), R=$(t_label_right), OUT=$(t_symdiff) using TensorOperations.tensorcontract"
                t = TensorOperations.tensorcontract(
                    t_left, t_label_left,
                    t_right, t_label_right,
                    t_symdiff
                )
            end
        end
...
Generates random tensors of decreasing rank to performan contractions with.
